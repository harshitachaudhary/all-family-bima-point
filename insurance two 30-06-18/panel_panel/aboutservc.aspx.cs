...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            txtheading.Text = all.showpagecontent("aboutservices");
            BindEmployeeDetails();
        }
    }
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from tblaboutsrvc", con);
    ...
    protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
       ...
       // string username = gvDetails.DataKeys[e.RowIndex].Values["UserName"].ToString();
        ...
        cmd.Parameters.AddWithValue("@icon", txtdesig.Text);
    ...
    protected void Button1x_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@typee", "aboutservices");
