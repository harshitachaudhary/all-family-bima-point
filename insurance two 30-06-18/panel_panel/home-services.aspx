<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="home-services.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">home-services</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  <div class="widget">
                        <div class="widget-title">
                           <%--<h4><i class="icon-user"></i>Manage Here <span style="color:red;">Note :- Image Width:73px & Height:73px </span></h4>  --%>           
                        </div>
...
<EditItemTemplate>
    <asp:TextBox ID="txteditheading" runat="server" Text='<%#Eval("icon") %>'></asp:TextBox>

</EditItemTemplate>
<ItemTemplate>
<asp:Label ID="lblitemUsr" runat="server" Text='<%#Eval("icon") %>'/>
</ItemTemplate>
<FooterTemplate>
...
<EditItemTemplate>
    <asp:TextBox ID="txteditdegisnation" runat="server" Text='<%#Eval("servicename") %>'></asp:TextBox>

</EditItemTemplate>
<ItemTemplate>
<asp:Label ID="lblitesmUsr" runat="server" Text='<%#Eval("servicename") %>'/>
</ItemTemplate>
<FooterTemplate>
