<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="general-insurance .aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#"> General_insurance</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  <div class="widget">
                        <div class="widget-title">
                           <h4><i class="icon-user"></i>Update Here <span style="color:red">(Image Size:- Width:569px & Height:386px)</span></h4>             
                        </div>
