...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            {
                Editor1.Content = all.showpagecontent("life");

                Image1.ImageUrl = all.showpagecontent("lifeimg");

                dt = all.showpagecontentP("life");
                if(dt.Rows.Count > 0)
                {
    ...
    protected void Button1x_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@typee", "life");
    ...
    public void image()
    {
        ...
        SqlCommand cmd = new SqlCommand("proc_tblallpages", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@typee", "lifeimg");
