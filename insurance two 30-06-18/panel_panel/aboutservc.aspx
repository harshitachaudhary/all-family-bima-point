<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="aboutservc.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">About Services</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-user"></i>Manage Here <span style="color: red;">Note :- Image Width:179px & Height:179px </span></h4>
                </div>
                                    ...
                                    <asp:GridView ID="gvDetails" DataKeyNames="id" runat="server" Width="80%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Icon">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txteditdegisnation" runat="server" Text='<%#Eval("icon") %>'></asp:TextBox>

                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblitesmUsr" runat="server" Text='<%#Eval("icon") %>' />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Description">
                                                ...
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtftrcity" runat="server" Width="82%" />
