<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="servicesmainpage.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#"> services</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
                           ...
                           <div class="about-us">
                               ...
                               <div class="row-fluid">
                                     <div class="control-group">
                                       ...
                                       <div class="controls">
                                           <asp:DropDownList ID="ddlChooseInsuranceCategory" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlChooseInsuranceCategory_SelectedIndexChanged"></asp:DropDownList>
                                  ...
                                  <div class="row-fluid">
                                     <div class="control-group">
                                       ...
                                       <div class="controls">
                                           ...
                                           <cc1:Editor ID="Editor1" runat="server" Height="700px" Width="750px" />
