...
public partial class frontmainmaster : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rpterheadrlogo.DataSource = all.showpagecontentP("headerlogo");
            rpterheadrlogo.DataBind();


            rptfootrlogo.DataSource = all.showpagecontentP("footerlogo");
            rptfootrlogo.DataBind();
