<%@ Page Title="" Language="C#" MasterPageFile="~/frontmainmaster.master" AutoEventWireup="true" CodeFile="health-insurance.aspx.cs" Inherits="healthinsurance" %>
					...
					<div class="Page-title">
						<div class="col-md-12 text-center">
							<div class="title-text">
								...
								<h2 class="page-title">Health Insurance</h2>
							</div>
						</div>
						<div class="col-md-12 text-center">
							<div class="breadcrumb-trail breadcrumbs">
								<span class="trail-begin"><a href="default.aspx">Home</a></span>
								<span class="sep">/</span> <span class="trail-end">Health Insurance</span>
							</div>
						</div>
					</div>
				</div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="insurance-single-item-nav-holder">
								...
								<ul class="nav nav-tabs tabs-left"><!-- 'tabs-right' for right tabs -->
									...
									<li class="active"><a href="health-insurance.aspx">Health Insurance <i class="fa fa-angle-right"></i></a></li>
