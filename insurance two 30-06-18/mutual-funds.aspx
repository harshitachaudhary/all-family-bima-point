<%@ Page Title="" Language="C#" MasterPageFile="~/frontmainmaster.master" AutoEventWireup="true" CodeFile="mutual-funds.aspx.cs" Inherits="mutualfunds" %>
					...
					<div class="Page-title">
						...
						<div class="col-md-12 text-center">
							<div class="breadcrumb-trail breadcrumbs">
								...
								<span class="sep">/</span> <span class="trail-end">Mutual Funds</span>
							</div>
						</div>
					</div>
				</div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="insurance-single-item-nav-holder">
								...
								<ul class="nav nav-tabs tabs-left"><!-- 'tabs-right' for right tabs -->
									...
									<li  class="active"><a href="mutual-funds.aspx">Mutual Fund <i class="fa fa-angle-right"></i></a></li>
