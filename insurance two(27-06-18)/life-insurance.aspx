<%@ Page Title="" Language="C#" MasterPageFile="~/frontmainmaster.master" AutoEventWireup="true" CodeFile="life-insurance.aspx.cs" Inherits="lifeinsurance" %>
                                  ...
                                  <asp:Image ID="Image1" class="img-responsive col-lg-8 col-md-7 col-sm-12 col-xs-12" runat="server" />
										...
										<div class="text col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <p style="text-align:justify;">
                                              ...
                                              <%--<asp:Repeater ID="RptPlanDetail" runat="server"><ItemTemplate>
                                                <a href="plan.aspx?insutype=<%# Eval("heading") %>"  class="btn btn-large main-bg">View Plan</a>
