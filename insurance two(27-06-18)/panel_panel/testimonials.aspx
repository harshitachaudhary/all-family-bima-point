    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">Testimonials</a><span class="divider">&nbsp;</span></li>
                <li><a href="#">What client says</a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
                                    ...
                                    <asp:GridView ID="gvDetails" DataKeyNames="id" runat="server" Width="80%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Designation">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txteditdegisnation" runat="server" Text='<%#Eval("degisnation") %>'></asp:TextBox>

                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblitesmUsr" runat="server" Text='<%#Eval("degisnation") %>' />
                                                </ItemTemplate>
                                                <FooterTemplate>
