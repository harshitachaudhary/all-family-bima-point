<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="create-Subadmin.aspx.cs" Inherits="nyksi_panel_create_Subadmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Subadmin</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  <div class="widget">
                        <div class="widget-title">
                           <h4><i class="icon-user"></i>Create Here</h4>             
                        </div>
  ...
  <div class="form-actions clearfix">
                           <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-success" OnClick="btnSubmit_Click" ValidationGroup="tt"></asp:Button>    
       <asp:Button ID="btnupdate" runat="server" Text="Update" CssClass="btn btn-success" OnClick="btnupdate_Click" ValidationGroup="tt" Visible="false"></asp:Button>    
