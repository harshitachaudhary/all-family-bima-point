<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="service-plan.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
                 ...
                 <form action="#" class="form-horizontal" id="fhgfh" runat="server">
                           ...
                           <div class="about-us">
                               ...
                               <div class="row-fluid">
                                ...
                                <div class="row-fluid">
                                     <div class="control-group">
                                       <label class="control-label">Upload Plan File :
                                          
                                       </label>
                                       <div class="controls">

                                           <asp:FileUpload ID="FileUpload1" runat="server"  title="Upload Plan File"/>
