<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="queryform.aspx.cs" Inherits="panel_panel_contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row-fluid">
     ...
     <asp:BoundField  DataField="name" HeaderText="Name" />
          ...
          <asp:BoundField  DataField="typeofinsurance" HeaderText="Type Of Insurance" />
